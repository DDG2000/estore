...
switch ($requestPageName) {
	...
	case 'cxsx.php' :
		...
		break;
	case 'cxsxinfo.php' :
		$title = '网上书店 - 网上畅销书询详细信息';
		break;		
	case 'pub.php' :
		$title = '网上书店 - 出版社分类列表';
		break;
	case 'pubbook.php' :
		$title = '网上书店 - 出版社分类图书列表';
		break;	
	case 'tell.php' :
		$title = '网上书店 - 新闻公告';
		break;								
