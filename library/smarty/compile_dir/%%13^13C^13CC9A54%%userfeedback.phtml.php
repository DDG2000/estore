<?php /* Smarty version 2.6.19, created on 2010-06-12 07:06:14
         compiled from userfeedback.phtml */ ?>
...
/userfeedback.html" class="a1">意见反馈</a></div>
            <div style="width:50px; height:5px; font-size:0px"></div>  
            <div style="width:95%; height:25px; padding-top:5px; border:1px solid #0C92AB; text-align:left; padding-left:50px; background:url(<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/img/button_ucenter.gif)">·&nbsp;<a href="#" class="a1">QQ在线咨询</a></div>
            <div style="width:50px; height:5px; font-size:0px"></div> 
            <div style="width:95%; height:25px; padding-top:5px; border:1px solid #0C92AB; text-align:left; padding-left:50px; background:url(<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/img/button_ucenter.gif)">·&nbsp;<a href="#" class="a1">服务热线</a></div>                                               
        </div>
        ...
        <div style="width:720px; height:100%; float:right">
            ...
            <form name="form_feedback" method="post" action="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/userfeedback.html" onsubmit="return chkUserfeedback(this)">
            <div style="width:100%; height:180px; text-align:left; padding-top:5px; padding-left:50px">
                 反馈主题：<input type="text" name="title" size="60" class="input" /><br /><br />
          反馈内容：<textarea name="content" cols="60" rows="6" class="input"></textarea><br /><br />      
