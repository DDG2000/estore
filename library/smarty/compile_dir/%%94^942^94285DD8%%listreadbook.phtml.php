<?php /* Smarty version 2.6.19, created on 2009-06-10 06:37:52
         compiled from listreadbook.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'listreadbook.phtml', 32, false),)), $this); ?>
...
/listreadbook-<?php echo $this->_tpl_vars['bookinfos']['first']; ?>
.html" class="a1">首页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listreadbook-<?php echo $this->_tpl_vars['bookinfos']['previous']; ?>
.html" class="a1">上一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listreadbook-<?php echo $this->_tpl_vars['bookinfos']['next']; ?>
.html" class="a1">下一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listreadbook-<?php echo $this->_tpl_vars['bookinfos']['last']; ?>
.html" class="a1">尾页</a>
          </li>           
          <?php endif; ?>
    </div> 
...
/img/button_info.gif" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->_tpl_vars['system'][0]['readurl']; ?>
/download.php?rid=<?php echo $this->_tpl_vars['bookinfos']['data'][$this->_sections['pbID']['index']]['readid']; ?>
&filename=<?php echo $this->_tpl_vars['bookinfos']['data'][$this->_sections['pbID']['index']]['filename']; ?>
"><img src="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/img/button_sdcz.gif" border="0"/></a></li>                            
            </div>
