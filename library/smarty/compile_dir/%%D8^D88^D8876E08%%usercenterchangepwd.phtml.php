<?php /* Smarty version 2.6.19, created on 2010-06-12 07:06:05
         compiled from usercenterchangepwd.phtml */ ?>
...
/img/button_ucenter.gif)">·&nbsp;<a href="#" class="a1">服务热线</a></div>                                               
        ...
        <div style="width:720px; height:100%; float:right">
            ...
            <form name="form_userpwd" method="post" action="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/usercenterchangepwd.html" onsubmit="return chkChangePwd(this)">
            <div style="width:100%; height:300px; text-align:left; padding-top:5px; padding-left:50px">
                  原密码：&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="oldpwd" size="30" class="input"/><br /><br />
                   新密码：&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="pwd1" size="30" class="input"/><br /><br /> 
                   确认新密码：<input type="password" name="pwd2" size="30" class="input"/><br /><br />             
